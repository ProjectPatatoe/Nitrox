...
{
    class BulkheadDoor_SetState_Patch : NitroxPatch, IDynamicPatch
    {
        public static readonly Type TARGET_CLASS = typeof(BulkheadDoor);
        public static readonly MethodInfo TARGET_METHOD = TARGET_CLASS.GetMethod(nameof(BulkheadDoor.SetState), BindingFlags.Instance | BindingFlags.Public);
